...
uimage varchar(200),
ustatus varchar(300),
ustatustime datetime,
uonline bit
)  

insert into users values('Mitesh Vora','miteshvora18@gmail.com','8-7-1989','RGIT','BE EXTC','Male','miteshvora18','mitesh','Mitesh.jpg','','',0)

create table communication
(
comid int identity(1,1) primary key,
fromUser int foreign key(fromUser) references Users(uid),
toUser int foreign key(toUser) references Users(uid),
content varchar(500),
unread bit,
ctime datetime
)

--insert into communication values(3,1,'Hi first message..',0,'2014-03-05 00:34:32.330')
--Part2 Groups
